"""Export Bauan retailer logos — clear outer background, keep internal artwork."""
...
SRC_DIR = Path(r"c:\Users\acer\Downloads\Bauan-20260612T144659Z-3-001\Bauan")
OUT_DIR = ROOT / "assets" / "logo" / "bauan"
...
SLUG_LOGO = {
    "dyans": "dyans.png",
    "jorjhanesstarita": "jhorjhanes.png",
    "hmmmuzon": "hmm.png",
    "sidcbauan": "sidc.png",
    "sidcstateresita": "sidc.png",
    "aalomitaal": "aa-lomi.png",
    "ofels": "ofels.png",
    "bulabog": "bulabog.png",
}

FALLBACK_SLUGS = ("ofels", "bulabog")
